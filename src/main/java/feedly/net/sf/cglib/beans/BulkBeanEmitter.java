 ...
 */
package feedly.net.sf.cglib.beans;
...
class BulkBeanEmitter extends ClassEmitter {
    ...
    private static final Type BULK_BEAN =
      TypeUtils.parseType("feedly.net.sf.cglib.beans.BulkBean");
    private static final Type BULK_BEAN_EXCEPTION =
      TypeUtils.parseType("feedly.net.sf.cglib.beans.BulkBeanException");
