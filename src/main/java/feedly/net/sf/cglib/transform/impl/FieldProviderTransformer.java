 ...
 */
package feedly.net.sf.cglib.transform.impl;

import java.util.HashMap;
import java.util.Map;

import feedly.net.sf.cglib.core.CodeEmitter;
import feedly.net.sf.cglib.core.CodeGenerationException;
import feedly.net.sf.cglib.core.Constants;
import feedly.net.sf.cglib.core.EmitUtils;
import feedly.net.sf.cglib.core.ObjectSwitchCallback;
import feedly.net.sf.cglib.core.ProcessSwitchCallback;
import feedly.net.sf.cglib.core.Signature;
import feedly.net.sf.cglib.core.TypeUtils;
...
public class FieldProviderTransformer extends ClassEmitterTransformer {
    ...
    private static final Type FIELD_PROVIDER =
      TypeUtils.parseType("feedly.net.sf.cglib.transform.impl.FieldProvider");
    ...
    public FieldVisitor declare_field(int access, String name, Type type, Object value) {
        FieldVisitor fv = super.declare_field(access, name, type, value);
