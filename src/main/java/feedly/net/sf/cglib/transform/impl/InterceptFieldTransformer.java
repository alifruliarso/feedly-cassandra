...
import feedly.net.sf.cglib.core.Local;
...
public class InterceptFieldTransformer extends ClassEmitterTransformer {
    ...
    private static final Type CALLBACK =
      TypeUtils.parseType("feedly.net.sf.cglib.transform.impl.InterceptFieldCallback");
    private static final Type ENABLED =
      TypeUtils.parseType("feedly.net.sf.cglib.transform.impl.InterceptFieldEnabled");
