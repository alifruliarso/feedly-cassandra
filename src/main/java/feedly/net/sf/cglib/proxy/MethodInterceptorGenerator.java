 ...
 */
package feedly.net.sf.cglib.proxy;

import java.lang.reflect.Method;
import java.util.*;
import feedly.net.sf.cglib.core.*;
...
implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
      TypeUtils.parseType("feedly.net.sf.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
      TypeUtils.parseType("feedly.net.sf.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
      TypeUtils.parseType("feedly.net.sf.cglib.proxy.MethodInterceptor");
